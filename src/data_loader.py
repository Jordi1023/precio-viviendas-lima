...
def generar_datos_lima(n_muestras: int = 200, semilla: int = 42) -> pd.DataFrame:
    ...
    distritos = [
        ...
        "La Molina", "Jesús María", "Lince", "Pueblo Libre",
    ]

    precios_base = {
        "Miraflores": 3200, "San Isidro": 3500, "Surco": 2800,
        "Barranco": 2900, "La Molina": 2600, "Jesús María": 2200,
        "Lince": 2000, "Pueblo Libre": 2100,
    }
